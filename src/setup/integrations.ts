...
export const INTEGRATION_RECIPES: readonly IntegrationRecipe[] = [
  ...
  },
  {
    ...
    status: "works today",
    scope: "external",
    network: "GitHub Actions only; CI checks comments and never uploads transcripts",
    files: [".github/workflows/pr-receipt-check.yml"],
    start: "paste the reusable workflow caller below",
    undo: "remove .github/workflows/pr-receipt-check.yml",
    snippet: [
    ...
    notes: [
      ...
      "Fork PRs stay advisory, and CI never generates receipts.",
    ],
  },
];
